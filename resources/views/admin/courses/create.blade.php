<x-admin-premium-layout>
    <div class="flex flex-wrap items-center justify-between gap-4 mb-8">
        <div>
            <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Tambah Mata Kuliah</h1>
    ...
    <div class="max-w-3xl">
        <div class="bg-white rounded-3xl border border-gray-100 card-shadow overflow-hidden">
            <div class="p-8 border-b border-gray-50">
                <h3 class="font-bold text-gray-800 text-lg">Informasi Mata Kuliah</h3>
                <p class="text-sm text-gray-400">Lengkapi data mata kuliah sesuai kurikulum yang berlaku.</p>
            </div>
            <div class="p-8">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input id="code" name="code" type="text" 
                                    class="w-full pl-12 pr-4 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-orange-500 transition-all text-gray-700 font-medium placeholder:text-gray-300 uppercase"
