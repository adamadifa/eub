<x-admin-premium-layout>
    ...
    <div class="bg-white rounded-3xl border border-gray-100 card-shadow overflow-hidden">
        <div class="p-8 border-b border-gray-50 flex flex-wrap items-center justify-between gap-4">
            <h3 class="font-bold text-gray-800 text-lg">Daftar Dosen Pengampu</h3>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-100">
                <thead class="bg-gray-50/50">
                    <tr>
                        <th class="px-8 py-4 text-left text-xs font-bold text-gray-400 uppercase tracking-widest">Dosen</th>
                        <th class="px-8 py-4 text-left text-xs font-bold text-gray-400 uppercase tracking-widest">NIDN</th>
                        ...
                        <tr class="hover:bg-gray-50/50 transition">
                            <td class="px-8 py-5 whitespace-nowrap">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p class="text-sm font-bold text-gray-800">{{ $lecturer->user->name }}</p>
                                        <p class="text-xs text-gray-400 font-medium">{{ $lecturer->title }}</p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-8 py-5 whitespace-nowrap">
                                <span class="text-sm font-medium text-gray-600">{{ $lecturer->nidn }}</span>
                            </td>
                            <td class="px-8 py-5 whitespace-nowrap">
                                <span class="text-sm text-gray-500">{{ $lecturer->user->email }}</span>
                            </td>
                        ...
                        <tr>
                            <td colspan="4" class="px-8 py-12 text-center">
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <p class="text-gray-400 font-medium">Belum ada data dosen.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
        ...
        <div class="p-8 bg-gray-50/30 border-t border-gray-50">
            <div class="flex items-center justify-between text-sm text-gray-400 font-medium">
                <p>Total: {{ $lecturers->count() }} Dosen Terdaftar</p>
            </div>
        </div>
    </div>
</x-admin-premium-layout>
