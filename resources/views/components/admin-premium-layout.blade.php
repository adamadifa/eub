...
<body class="bg-gray-50 overflow-x-hidden">
    ...
    <aside id="sidebar" class="fixed left-0 top-0 h-full w-64 bg-white border-r border-gray-100 z-50 transition-transform transform lg:translate-x-0 -translate-x-full">
        <div class="p-6 flex items-center gap-3">
            ...
            <span class="text-2xl font-bold text-gray-800">EUB<span class="text-orange-500">System</span></span>
        </div>
                ...
                <nav class="space-y-1">
                    ...
                    <div class="space-y-1">
                        ...
                        <div id="ques-dropdown" class="{{ request()->routeIs('admin.questionnaires.*') ? '' : 'hidden' }} pl-12 space-y-1 mt-1">
                            <a href="{{ route('admin.questionnaires.index') }}" class="block py-2 text-sm font-medium {{ request()->routeIs('admin.questionnaires.index') ? 'text-orange-500' : 'text-gray-500 hover:text-orange-500' }} transition">Daftar Template</a>
                            <a href="{{ route('admin.questionnaires.create') }}" class="block py-2 text-sm font-medium {{ request()->routeIs('admin.questionnaires.create') ? 'text-orange-500' : 'text-gray-500 hover:text-orange-500' }} transition">Buat Baru</a>
                        </div>
                    </div>
                </nav>
            </div>
        ...
        <header class="bg-white/80 backdrop-blur-md sticky top-0 z-40 border-b border-gray-100 flex items-center justify-between px-6 py-3">
            <div class="flex items-center gap-4">
                ...
                <div class="relative hidden md:block">
                    ...
                    <input type="text" placeholder="Search data... (CTRL + K)" class="pl-10 pr-4 py-2 bg-gray-100 border-none rounded-full text-sm w-80 focus:ring-2 focus:ring-orange-500 transition-all">
                </div>
            </div>
            ...
            <div class="flex items-center gap-2 md:gap-4">
                ...
                <div class="flex items-center gap-3 ml-2">
                    ...
                    <div class="flex items-center gap-2">
                        <img src="https://ui-avatars.com/api/?name={{ auth()->user()->name }}&background=f97316&color=fff" alt="Profile" class="h-9 w-9 rounded-full border-2 border-orange-100 shadow-sm">
